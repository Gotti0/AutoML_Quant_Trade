...
class CapitalAllocator:
    ...
    W_STAR: Dict[str, List[float]] = {
        "Regime":    [0.30, 0.25, 0.15],  # 국면 적응: 불장에 모멘텀, 폭락장에 비중 축소
        "Anomaly":   [0.25, 0.30, 0.30],  # 이상 탐지: 변동성 장세/폭락장에서 안전망 역할
        "Cluster":   [0.30, 0.20, 0.00],  # 군집 모멘텀: 강세장 주도주, 폭락장 청산
        "Long_Safe": [0.15, 0.25, 0.55],  # 장기 가치: 약세/폭락 시 방어 및 저가 매수
    }
